...
def test_chat_completion(model="openrouter/free"):
    """测试聊天完成 API"""
    print("\n" + "=" * 50)
...
def main():
    ...
    # 测试 2: 聊天完成
    results.append(("聊天完成 (openrouter/free)", test_chat_completion("openrouter/free")))
